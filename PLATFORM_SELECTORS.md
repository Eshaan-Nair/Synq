...
## How the Selector System Works (v1.4.7)

As of v1.4.7, **input box selectors** use a multi-strategy resolver defined centrally in `extension/src/platform/resolver.ts`.
